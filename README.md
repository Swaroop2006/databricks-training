...
Successfully practiced SQL queries covering:
...
* Fetching all records using SELECT *
...
* Using LIKE operator
* Working with % and _ wildcards
* Searching names with specific characters and patterns
...
* Using GROUP BY for department-wise analysis
